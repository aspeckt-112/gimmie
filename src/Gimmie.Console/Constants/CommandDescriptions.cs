...
internal static class CommandDescriptions
{
    ...
    /// </summary>
    public const string HashSha256 = "Generates a SHA-256 hash.";

    /// <summary>
    /// The description for the 'sha224' subcommand under the 'hash' command.
    /// </summary>
    public const string HashSha224 = "Generates a SHA-224 hash.";

    /// <summary>
    /// The description for the 'sha512' subcommand under the 'hash' command.
    /// </summary>
    public const string HashSha512 = "Generates a SHA-512 hash.";

    /// <summary>
    /// The description for the 'sha384' subcommand under the 'hash' command.
    /// </summary>
    public const string HashSha384 = "Generates a SHA-384 hash.";
}
